...
/// Flexible option for normal spans or spans that may come from runtime
/// parsing.
///
/// Only used in diagnostics, not for tracking source. In that case, only the
/// start span will be used from runtime parsing.
#[derive(Debug, Clone, Eq, PartialEq, Hash)]
...
impl SourceDiagnostic {
    ...
    /// Create an error at an initial node plus a number of siblings.
    ...
    /// The file id of the error's span.
