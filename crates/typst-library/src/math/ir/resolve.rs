...
fn resolve_vertical_frac_like<'a>(
    ctx: &mut MathResolver<'a, '_, '_>,
    styles: StyleChain<'a>,
    num: &'a Content,
    denom: &[Content],
...
/// annotation.
fn resolve_underoverspreader<'a>(
    ctx: &mut MathResolver<'a, '_, '_>,
    styles: StyleChain<'a>,
    body: &'a Content,
