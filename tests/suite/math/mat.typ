...
#let nums = range(0, 2).map(i => (i, i+1))
// Error: 16-17 expected array, found content
$ .mat(..nums, 0, 1) $
...
// Error: 3-38 cannot draw a vertical line at offset 4 in a matrix with 3 columns
...
// Warning: 22-31 linebreaks are ignored in cells
