...
// Error: 12-13 expected a value to the right of the operator
// Error: 18-19 expected a value to the right of the operator
// Error: 23-24 expected a value to the left of the operator
$ a _ b (d _) (d'_ ) (_ c) $
